...
public class NotificationController {
    ...
    //생성
    @PostMapping
    public ResponseEntity<NotificationResponseDto> createNotification(@RequestBody NotificationCreateRequestDto requestDto) {
        return ResponseEntity.ok(notificationService.createNotification(requestDto));
    }

    //업데이트
    @PutMapping("/{notificationId}")
    public ResponseEntity<NotificationResponseDto> updateNotification(@PathVariable Long notificationId, @RequestBody NotificationUpdateRequestDto requestDto) {
